...
[![Tests](https://img.shields.io/github/actions/workflow/status/yokai-php/batch-src/tests.yml?branch=1.x&style=flat-square&label=tests)](https://github.com/yokai-php/batch-src/actions)
